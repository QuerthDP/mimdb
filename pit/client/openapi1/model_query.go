...
// GetQueryDefinition returns the QueryDefinition field value if set, zero value otherwise.
func (o *Query) GetQueryDefinition() QueryQueryDefinition {
	if o == nil || IsNil(o.QueryDefinition) {
...
// GetQueryDefinitionOk returns a tuple with the QueryDefinition field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetQueryDefinition gets a reference to the given QueryQueryDefinition and assigns it to the QueryDefinition field.
