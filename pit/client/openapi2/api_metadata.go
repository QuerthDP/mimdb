...
*/
func (a *MetadataAPIService) GetSystemInfo(ctx context.Context) ApiGetSystemInfoRequest {
	return ApiGetSystemInfoRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *MetadataAPIService) GetSystemInfoExecute(r ApiGetSystemInfoRequest) (*SystemInformation, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MetadataAPIService.GetSystemInfo")
	if err != nil {
